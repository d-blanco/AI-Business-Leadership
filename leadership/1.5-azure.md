...
- Postgresql database: stores our products, customers, and sales data
- MCP Container Application: A Model Context Protocol server that allows AI Agents to use Text-To-SQL to retrive data
- Foundry Hub and Project - Microsofts AI .....
- Search Service - Azure Search is a ......
...
Select the reviews-rag. (hey AI explain what this index is, it was built from the reviews csv. as a semantic search, it used a foundry text embedding module. Explain that this is a RAG database for semantic search)


Use this index to search customer reviews. The semantic search is superior to text-search because....
...
1. In the Azure Portal search bar, search for **"Foundry"** and select **Azure AI Foundry**. You can also use the global resourcce group to find the foundry project.
